      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-10">
        ...
        <section>
          ...
          <div className="prose prose-stone font-inter text-stone-600 space-y-3">
            ...
            <ol>
              <li>Contactez-nous par email à <a href="mailto:contact@labrocantedusud.fr" className="text-terracotta-500">contact@labrocantedusud.fr</a> en précisant votre numéro de commande.</li>
